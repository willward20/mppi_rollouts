...
sys.path.append(f'{home}/function-encoder-terrain-adaptation/src')
from data.load_data import load_all_scenes, PhoenixDataset
from models.neural_ode import load_model as load_model_ode
from models.function_encoder import load_model as load_model_fe
