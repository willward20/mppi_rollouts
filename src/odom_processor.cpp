...
#include <mppi_rollouts/OdomProcessed.h>
...
public:
    OdomProcessor()
    {
        ...
        odom_pub_ = nh_.advertise<mppi_rollouts::OdomProcessed>("/warty/odom_processed", 10);
    }
...
private:
    ...
    void odomCallback(const nav_msgs::Odometry::ConstPtr& odom)
    {
        ...
        mppi_rollouts::OdomProcessed processed_odom;
